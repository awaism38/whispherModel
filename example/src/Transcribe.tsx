        ...
        <View style={styles.buttons}>
          <Button
            ...
            onPress={async () => {
              ...
              const endTime = Date.now()
              const transcriptionPath = `${fileDir}/transcription-${Date.now()}.json`
              ...
              await RNFS.writeFile(
                transcriptionPath,
                JSON.stringify(transcriptionPayload, null, 2),
                'utf8',
              )
              log('Saved transcription JSON →', transcriptionPath)
              ...
              setTranscibeResult(
                `Transcribed result: ${result}\n` +
                  ...
                  `\n${segments
                    ...
                    .join('\n')}` +
                  `\nSaved transcription JSON at: ${transcriptionPath}`,
              )
